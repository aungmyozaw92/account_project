        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Active::pattern('admin/dashboard') }}">
               ...
               @permission('view-access-management')
                <li class="{{ Active::pattern('admin/access/users*') }}{{ Active::pattern('admin/access/roles*') }}">
                    <a href="{!!url('admin/access/users')!!}"><span>{{ trans('menus.backend.access.title') }}</span></a>
                </li>

                <li class="{{ Active::pattern('admin/access/category*') }}">
                    <a href="{!!url('admin/access/category')!!}"><span>{{ trans('menus.backend.access.category.title') }}</span></a>
                </li>
